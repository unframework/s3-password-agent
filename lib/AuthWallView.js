    ...
    return h('div', {
        ...
        h('div', {
            style: {
                ...
                background: isMinimized ? '#e0e0e0' : 'radial-gradient(ellipse farthest-corner at 50% 50%, rgba(255, 255, 255, 1) 0%, rgba(192, 192, 192, 0.9) 100%)',
                opacity: isMinimized ? 0 : 0.8, // fade-in starts at zero
    ...
    this.render = function () {
        if (!auth.getSessionIsActive()) {
            return renderRoot(h, false, [
                heading(h, 'Access Downloadable Content'),
                gutter(h),
                form(h, 'Sign In', [
